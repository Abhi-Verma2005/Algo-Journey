...
import {
  ...
  fetchLatestSubmissionsLeetCode,
  fetchUserStats,
} from "@/serverActions/fetch";
...
export default function Dashboard() {
    ...
    try {
      ...
      return {
        ...
        userStats: {
          ...
          groupMembers:
            contestsResponse.data.user?.group?._count?.members || null,
          isCoordinator: contestsResponse.data.user?.coordinatedGroup
            ? true
            : false,
        },
      };
  ...
  const fetchPlatformData = async (): Promise<PlatformData> => {
    try {
      ...
      setPUsernames({
        leetcodeUsername: usernameRes.data.leetcodeUsername,
        codeforcesUsername: usernameRes.data.codeforcesUsername,
      });

      if (
        !usernameRes.data.leetcodeUsername ||
        !usernameRes.data.codeforcesUsername
      ) {
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              >
                Welcome back,{" "}
                <span className="text-pink-400">{dashboardData?.username}</span>
              </h1>
              <p
                className={`${
          ...
          <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
            {loadingContest ? (
              ...
              >
                ...
                <div
                  className={`h-3 w-24 ${
                    isDarkMode ? "bg-[#404040]" : "bg-zinc-300"
                  } rounded`}
                ></div>
              </div>
            ) : (
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    {dashboardData?.userStats.totalSubmissions}
                  </p>
                  {/* <p
                    className={`text-xs ${
            ...
            {loadingContest ? (
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    {dashboardData?.userStats.totalPoints}
                  </p>
                  {/* <p
                    className={`text-xs ${
                      isDarkMode ? "text-zinc-400" : "text-zinc-500"
          ...
          <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-2">
            ...
            {loadingPlatformData ? (
              ...
              >
                <CardHeader
                  className={`${
                    isDarkMode ? "border-[#404040]" : "border-zinc-100"
                  } border-b pb-4`}
                >
                ...
                <CardContent className="pt-4">
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      >
                        {platformData?.leetcodeData?.totalSolved || 0} /{" "}
                        {platformData?.leetcodeData?.totalQuestions || 0}
                      </span>
                    </div>
                    <div
                      className={`w-full ${
                    ...
                    >
                      {platformData?.leetcodeData && (
                        <div
                          ...
                          style={{
                            width: `${
                              (platformData?.leetcodeData?.totalSolved /
                                platformData?.leetcodeData?.totalQuestions) *
                                100 || 0
                            }%`,
                          }}
                        ></div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-4">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            /{platformData?.leetcodeData?.totalEasy || 0}
                          </span>
                        </div>
                        <div
                          className={`w-full ${
                            isDarkMode ? "bg-green-900/30" : "bg-green-200"
                          } rounded-full h-1.5 mt-1`}
                        >
                          {platformData?.leetcodeData && (
                            <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            /{platformData?.leetcodeData?.totalMedium || 0}
                          </span>
                        </div>
                        <div
                          className={`w-full ${
                            isDarkMode ? "bg-amber-900/30" : "bg-amber-200"
                          } rounded-full h-1.5 mt-1`}
                        >
                          {platformData?.leetcodeData && (
                            <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            /{platformData?.leetcodeData?.totalHard || 0}
                          </span>
                        </div>
                        <div
                          className={`w-full ${
                ...
                >
                  <div className="flex justify-between items-center w-full">
                    ...
                    >
                      ...
                      {platformData?.leetcodeData?.ranking || "N/A"}
                    </div>
                    <Link
                      href={`https://leetcode.com/u/${platformData?.leetcodeData?.leetcodeUsername}/`}
                      target="_blank"
                    >
                      <Button
                        ...
                        className={`shadow-none ${
                          isDarkMode
                            ? "border-zinc-600 text-blue-400 hover:bg-[#404040] hover:text-white"
                            : "border-zinc-200 hover:bg-indigo-50 text-indigo-600"
                        }`}
                      >
            ...
            {loadingPlatformData ? (
              ...
              >
                ...
                >
                  <Link
                    href={`https://codeforces.com/profile/${platformData?.codeforcesData?.codeforcesUsername}`}
                    target="_blank"
                  >
                    <Button
                      variant={!isDarkMode ? "outline" : "ghost"}
                      ...
                      className={`ml-auto ${
                        isDarkMode
                          ? "border-zinc-600 text-teal-400 hover:bg-teal-900/50"
                          : "border-zinc-200 hover:bg-teal-50 text-teal-600"
                      }`}
                    >
                      View Profile <ArrowUpRight className="ml-1 h-3 w-3" />
                    </Button>
          ...
          {loadingContest ? (
            <div
              className={`${
                isDarkMode ? "bg-[#262626]" : "bg-zinc-100"
              } rounded-lg border-0 shadow-none animate-pulse`}
            >
              <div
                className={`${
                  isDarkMode ? "border-[#404040]" : "border-zinc-100"
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      <div
                        className={`${
                          isDarkMode ? "bg-[#404040]" : "bg-zinc-50"
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className={`${
                      isDarkMode
                        ? "border-zinc-600 hover:bg-[#404040]"
                      ...
                      >
                        ...
                        {contest.status === "COMPLETED" && (
                          <Button
                            ...
                            className={`${
                              isDarkMode
                                ? "border-zinc-600 text-blue-400 hover:bg-blue-900/50"
                                : "border-zinc-200 hover:bg-blue-50 text-blue-400"
                            }`}
                        ...
                        {contest.status === "INACTIVE" && (
                          <Button
                            ...
                            className={`${
                              isDarkMode
                                ? "border-zinc-600 text-zinc-400 opacity-50 cursor-not-allowed"
                                : "border-zinc-200 hover:bg-zinc-50 text-zinc-600 opacity-50 cursor-not-allowed"
                            }`}
                            disabled
                          >
          ...
          {dashboardData?.userStats.groupName ? (
            ...
            >
                    ...
                    <div>
                      {Array.from({ length: 5 }).map((_, index) => (
                        <div
                          key={index}
                          className={`${
                            isDarkMode ? "border-[#404040]" : "border-zinc-50"
                          } border-b p-3 animate-pulse`}
                        >
                                  ...
                                  className={cn(
                                    `${
                                      isDarkMode
                                        ? "border-[#404040]"
                                        : "border-zinc-50"
                                    } border-b hover:bg-amber-300/10`,
                                    member.username === dashboardData.username
                                      ? isDarkMode
                                        ? "bg-amber-900/30"
                                        : "bg-amber-50"
                                      : ""
                                ...
                                >
                                  ...
                                  <TableCell className="py-3">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div>
                                        <Link
                                          href={`/user/updateProfile/${member.username}`}
                                          target="_blank"
                                        >
                                          <p
                                            className={`font-medium ${
              ...
              <CardFooter
                className={`${
                  isDarkMode ? "border-[#404040]" : "border-zinc-100"
                } border-t pt-4 flex justify-between`}
              >
                <Button
                  onClick={() => {
                  ...
                  className={`shadow-none ${
                    isDarkMode
                      ? "border-zinc-600 text-amber-400 hover:bg-amber-900/50"
                      : "border-zinc-200 hover:bg-amber-50 text-amber-600"
                  }`}
                >
            ...
            >
              ...
              <CardContent className="pt-4 flex flex-col items-center justify-center p-8">
                ...
                >
                  Join a team to collaborate with other developers, participate
                  in team challenges, and climb the leaderboard together.
                </p>
              </CardContent>
            </Card>
          )}
